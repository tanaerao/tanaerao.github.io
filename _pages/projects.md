...
permalink: /projects/
title: projects
description: selected research and writing.
nav: true
nav_order: 1
---
...
I co-authored two submissions to GiveWell's [Change Our Mind contest](https://blog.givewell.org/2022/12/15/change-our-mind-contest-winners/), both of which received honourable mentions ($2500 cash prize).

The first submission, co-authored with Sam Nolan and Hannah Rokebrand, refactored the entire GiveWell cost effectiveness analysis to quantify the uncertainty in each parameter, then argued that such uncertainty quantification is decision-relevant. I only did about 5-10% of the work for this project. I also received a prize individually for a previous draft of my section (on the Against Malaria Foundation) from the developers of [Squiggle](https://www.squiggle-language.com/), a "simple programming language for intuitive probabilistic estimation" ($600).

The second submission, co-authored with Ricky Huang, argued that GiveWell's current approach to weighing different moral outcomes is flawed, and suggested that GiveWell hire an academic practical ethicist (perhaps on a part-time or project basis) to conduct a thorough review of the current system. 
...
I was active on Medium from 2019-2021, during which time I published 33 articles about math, education, politics, etc. This helped me practice writing, especially for non-academic audiences.
